...
SRC_URI_BASE="http://opscode-omnibus-packages.s3.amazonaws.com"
SRC_URI="${SRC_URI_BASE}/ubuntu/12.04/x86_64/${MY_P}_amd64.deb"
...
src_install() {
    ...
    for binary in $binaries; do
        dosym /opt/chefdk/bin/$binary /usr/bin/$binary || die "Cannot link $binary"
    done
}
